...
void usart0_init( void )
{
	...
	//	1	0	|	Mode
	//-------------------------------
	//	0	0	|	Asyncronous USART
	//	0	1	|	Syncronous USART
	//	1	0	|	Reserved
	//	1	1	|	Master SPI
	...
	//XCK0 clock polarity (syncronous mode only)
...
**	reference for calibration porpouse
**
**	I will read:
...
void adc_init( void )
{
	...
	///----------------------------------------------------------------------
	///Note: The ADC register is not updated until ADCH is readed, so read ADCL FIRST
	///If this bit is written zero, the rappresentation will be:
	///	
	...
	///
	///If this bit is written one, the rappresentation will be:
	///	
	///			|	B7	|	B6	|	B5	|	B4	|	B3	|	B2	|	B1	|	B0	|
	///	--------------------------------------------------------------------------
	...
	///----------------------------------------------------------------------
	/// Writting this bit to one will start a conversion, the bit is cleared
	...
	///----------------------------------------------------------------------
	///	The adc will automaticaly start a new conversion on a positive edge of
	...
	///	input circuitery for that pin, this will reduce power consumation too
